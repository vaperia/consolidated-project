  ...
  osEE_tdb_array[7]  =
{
  ...
  },
  {
    ...
    /* .task_func      = */ TASK_FUNC(SensorTask),
    /* .ready_prio     = */ 5U,
    /* .dispatch_prio  = */ 5U,
    /* .max_num_of_act = */ 1U
  },
  {
    ...
    /* .task_func      = */ TASK_FUNC(ServoControlTask),
    /* .ready_prio     = */ 4U,
    /* .dispatch_prio  = */ 4U,
    /* .max_num_of_act = */ 1U
  },
  {
    ...
    /* .tid            = */ 3U,
    /* .task_type      = */ OSEE_TASK_TYPE_EXTENDED,
    /* .task_func      = */ TASK_FUNC(LEDControlTask),
    /* .ready_prio     = */ 3U,
    /* .dispatch_prio  = */ 3U,
    /* .max_num_of_act = */ 1U
  },
...
static VAR(OsEE_ResourceCB, OS_VAR_CLEARED) osEE_res_cb_array[5];



static VAR(OsEE_ResourceDB, OS_CONST) osEE_res_db_array[5] = {
  {
  ...
  {
    /* .p_cb              = */ &osEE_res_cb_array[2U],
    /* .prio              = */ 3U
  },
  {
    /* .p_cb              = */ &osEE_res_cb_array[3U],
    /* .prio              = */ 5U
  },
  {
    /* .p_cb              = */ &osEE_res_cb_array[4U],
    /* .prio              = */ 4U
  }
};
